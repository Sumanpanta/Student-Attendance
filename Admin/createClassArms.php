        ...
        <div class="container-fluid" id="container-wrapper">
          ...
          <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-body">
                  <form method="post">
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-xl-6">
                        <label class="form-control-label">Class Branch Name<span class="text-danger ml-2">*</span></label>
                      <input type="text" class="form-control" name="classBranchName" value="<?php echo $row['classBranchName'];?>" id="exampleInputFirstName" placeholder="Class Branch Name">
                        </div>
                    </div>
                      <?php
                    if (isset($Id))
              ...
              <div class="card mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                  <h6 class="m-0 font-weight-bold text-primary">All Class Branch</h6>
                </div>
