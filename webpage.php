...
<head>
  ...
  <link type="text/css" rel="stylesheet" href="Html/webpage.css">
</head>
...
<body>
  ...
  <div class="header">
    <div class="logo">
      <img src="./Html/logo.png" class=" img-responsive" alt="logo" width="60" height="60" />
    </div>
    <!--logo-->
  ...
  <div class="navbar">
    <a href="index.php" class="right">Login</a>
    <a href="Html/details.php" class="right">Attendence Details </a>
 ...
 <div class="flex h-screen">
  ...
  <div class="img2">
    ...
    <img src="./Html/school.png" alt="class" width:900px height:1000px>
  </div>

 </div>
  <div class="flex">
    <div class="img2">
      <img src="./Html/class.jpg" alt="class">
    </div>
  ...
  <div class="common_style">
    <section class="about_section">
      ...
      <div class="first_section">
        <div class="first_container ">
          <div class="img">
            <img src="./Html/Attendence.jpg" alt="about image">
          </div>
  ...
  <section id="why-choose-us">
    <div class="container">
      <div class="why-choose-col">
        ...
        <div class="flex">
          <div class="img">
            <img src="./Html/choose.jpg" width="600px">
          </div>
  ...
  <script type="text/javascript" src="Html/webpage.js"></script>
